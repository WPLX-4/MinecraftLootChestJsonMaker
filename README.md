...
Generate loot table data for Module [Module:LootChest](https://zh.minecraft.wiki/Module:LootChest) in Chinese Minecraft Wiki.

## Usage
Put `JsonMarker.py` in root directory of loot tables and run it.
